...
public class Utils {
    ...
    public static void setMobileDataEnabled(Context context, boolean enabled) {
        android.util.Log.d(TAG, "setMobileDataEnabled");
        String methodName;
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            try {
                android.util.Log.d(TAG, "setMobileDataEnabled LOLLIPOP 이하");
            ...
            try {
                android.util.Log.d(TAG, "setMobileDataEnabled LOLLIPOP 이상");
