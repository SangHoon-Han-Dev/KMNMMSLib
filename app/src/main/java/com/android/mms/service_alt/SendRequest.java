...
public class SendRequest extends MmsRequest {
    ...
    public SendRequest(RequestManager manager, int subId, Uri contentUri, String locationUrl,
        ...
        android.util.Log.d(TAG, "SendRequest");
        mPduUri = contentUri;
        mPduData = null;
    ...
    protected Uri persistIfRequired(Context context, int result, byte[] response) {
        ...
        android.util.Log.d(TAG, "SendRequest.persistIfRequired");
        if (mPduData == null) {
            android.util.Log.e(TAG, "SendRequest.persistIfRequired: empty PDU");
        ...
        try {
            ...
            if (pdu == null) {
                android.util.Log.e(TAG, "SendRequest.persistIfRequired: can't parse input PDU");
                Log.e(TAG, "SendRequest.persistIfRequired: can't parse input PDU");
                return null;
            }
            if (!(pdu instanceof SendReq)) {
                android.util.Log.d(TAG, "SendRequest.persistIfRequired: not SendReq");
...
//            }
            ...
            if (sendConf != null) {
                ...
                android.util.Log.v(TAG, "response status: " + sendConf.getResponseStatus());
            ...
            if (SqliteWrapper.update(context, context.getContentResolver(), mPduUri, values,
                ...
                android.util.Log.e(TAG, "SendRequest.persistIfRequired: failed to update message");
...
//            Log.e(TAG, "SendRequest.persistIfRequired: can not persist message", e);
            ...
            android.util.Log.e(TAG, "SendRequest.persistIfRequired: unexpected parsing failure", e);
...
//        carrierSendManger.sendMms(context, carrierMessagingServicePackage, sendCallback);
    ...
    protected void revokeUriPermission(Context context) {
        try {
            ...
            //2016.07.15 에러 주석처리
//            e.printStackTrace();
//            android.util.Log.d(TAG, "error revoking permissions", e);
//            Log.d(TAG, "error revoking permissions", e);
        }
    }
}
